...
const questions = [
  ...
  {
    question: "Translate: 'Ella es una mujer.'",
    options: [
  ...
  {
    question: "What is the pronunciation of 'Escuela'?",
    options: [
      { text: "es-kweh-la", isCorrect: true },
      { text: "eh-skool", isCorrect: false },
      { text: "es-ku-la", isCorrect: false },
    ],
  },
  {
    question: "What does 'Yo como pan.' mean?",
    options: [
  ...
  {
    question: "Translate: 'Tú lees un libro.'",
    options: [
...
const SpanishFinalQuiz = () => {
    ...
    if (user) {
      try {
        ...
        await updateDoc(userRef, {
          xp: increment(50),
          completedLessons: arrayUnion("Spanish - Final Quiz"),
          quizScores: arrayUnion({
            lesson: "Spanish - Final Quiz",
            score: score,
            attempts: 1,
          }),
        });
  ...
  return (
    <div className="final-quiz-container">
      <h1 className="quiz-title">Spanish Final Quiz</h1>
      ...
      {quizCompleted && (
        <div className="quiz-completion">
          <h2>🎉 ¡Felicidades! You've completed the Spanish Final Quiz!</h2>
      ...
      <div className="navigation-buttons">
        {!quizCompleted && (
          <button className="nav-btn" onClick={() => navigate("/spanishlesson/basics-3")}>
            ⬅ Previous Lesson
          </button>
        )}
        {quizCompleted && (
...
export default SpanishFinalQuiz;
